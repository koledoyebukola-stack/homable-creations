...
const MODE_CONTENT = {
  design: {
    ...
    images: [
      {
        url: '/images/photo1767213004.jpg',
        alt: 'Empty room with bare walls and floor - Before',
        label: 'Before'
      },
      {
        url: '/images/FurnishedRoom.jpg',
        alt: 'Same room now furnished with modern decor - After',
        label: 'After'
      }
    ]
  },
